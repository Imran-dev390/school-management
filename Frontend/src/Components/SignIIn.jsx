  ...
  {/* <div className="flex w-full items-center justify-center sm:shadow-xl bg-white p-4 sm:p-6 lg:p-8 lg:w-1/2 relative z-10"> */}
    ...
    <div className="w-full max-w-md space-y-6 shadow-xl p-8 lg:shadow-none ">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          type="submit"
          className="w-full bg-[rgb(1,1,93)]
 hover:bg-[rgb(193,151,5)] text-white font-medium py-2 rounded-lg transition duration-200"
          disabled={loading}
        >
          {loading ? 'Signing in...' : 'Sign In'}
        </button>
      ...
      <div className="text-center text-md space-y-1">
        <p className="font-semibold flex items-center justify-center gap-2">
          CS Help: <FiPhone className="text-indigo-600" /> <span className="font-bold">0333-1247237</span>
        </p>
        <p className="font-semibold flex items-center justify-center gap-2">
          Sale: <FiPhone className="text-green-600" /> <span className="font-bold">0333-1247237</span>
        </p>
      </div>
      {/* Role Cards */}
      <div className="grid grid-cols-2 gap-4 mt-6">
