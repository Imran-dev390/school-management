  ...
  const sections = [
    {
      title: 'Roles',
      actions: [
        { label: 'View Roles', href: '/admin/view/roles' },
         { label: 'Add New Role', href: '/admin/add/roles' },
      ],
    },
    {
      title: 'Staff List',
      actions: [
        { label: 'View Staff', href: '/admin/view/staff' },
        { label: 'Add New Staff', href: '/admin/add-new/staff' },
      ],
    },
  ];
  return (
       ...
       <div className="flex w-full h-full flex-col gap-3 mt-4">
        ...
        {/* Section Heading */}
                  <div className="w-full text-white  bg-[rgb(1,1,93)]  hover:bg-[#C19703] text-xl font-semibold flex items-center justify-center rounded-md py-3 shadow-md">
                    <i className="fas fa-graduation-cap mr-2"></i> Administrater
                  </div>
...
export default AdminAdministraterDash
